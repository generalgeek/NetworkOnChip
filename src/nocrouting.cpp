...
routingInfo routingXY(unsigned source, unsigned dest) {
    // NoCDebug::printDebug(std::string("Routing XY: " + std::to_string(source) + " --> " + std::to_string(dest)),
    //                      NoCDebug::Router);
    ...
    // NoCDebug::printDebug(
    //     std::string("Routing XY: DeltaX " + std::to_string(deltaX) + " DeltaY " + std::to_string(deltaY)),
    //     NoCDebug::Router);
    ...
    // Move in Y
        ...
        unsigned updated_source_router_x = (source + stepY * NOC_ROW_SIZE + 1) -
                                           (updated_source_router_y - 1) * NOC_ROW_SIZE;
...
routingInfo routingYX(unsigned source, unsigned dest) {
    NoCDebug::printDebug(std::string("Routing YX: " + std::to_string(source) + " --> " + std::to_string(dest)),
                         NoCDebug::Router);
    ...
    NoCDebug::printDebug(
        std::string("Routing YX: DeltaX " + std::to_string(deltaX) + " DeltaY " + std::to_string(deltaY)),
        NoCDebug::Router);
