...
enum CONSTANTS { INT_MEM_SIZE = 0x4000, DATA_SEGMENT_START = 0x2000 };
...
#define build_Hflit(orig, dest, cmd, size) \
    (((orig << 24) & 0xFF000000) | ((dest << 16) & 0xFF0000) | ((cmd << 10) & 0xFC00) | (size & 0x3FF))
...
enum NOC { P = 4, M0 = 3, DMA = 5, R_A = 0, M1 = 1, DSPL = 2 };
...
//
enum DATA_TYPE { BYTE = 4, INTEGER = 1 };
