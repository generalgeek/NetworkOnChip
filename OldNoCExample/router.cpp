...
void Router::Run(sc_uint<53> tmp) {
    ...
    if (ent == 0) {
        ...
        if (x > 0) {
            ...
            // Saida de debug
            if (debug >= 2)
                cout << "[" << this->name() << "]:Saida SUL (Saida de Debug) x: " << tmp.range(15, 8)
                     << " y: " << tmp.range(7, 0) << " ID de origem: " << tmp.range(18, 16) << "\n";
            tmp.range(15, 8) = x;
            o_sul->write(tmp);
            ...
            // Saida de debug
            if (debug >= 2)
                cout << "[" << this->name() << "]:Saida LESTE (Saida de Debug) x: " << tmp.range(15, 8)
                     << " y: " << tmp.range(7, 0) << " ID de origem: " << tmp.range(18, 16) << "\n";
            tmp.range(7, 0) = y;
            o_leste->write(tmp);
        ...
        if (said == 1) {
            if (x > 0) {
                ...
                // Saida de Debug
                if (debug >= 2)
                    cout << "[" << this->name() << "]:Saida NORTE (Saida de Debug) x: " << tmp.range(15, 8)
                         << " y: " << tmp.range(7, 0) << " ID de origem: " << tmp.range(18, 16) << "\n";
                tmp.range(15, 8) = x;
                o_norte->write(tmp);
            } else if (y > 0) {
        ...
        if (x > 0) {
            ...
            // Saida de Debug
            if (debug >= 2)
                cout << "[" << this->name() << "]:Saida OESTE (Saida de Debug) x: " << tmp.range(15, 8)
                     << " y: " << tmp.range(7, 0) << " ID de origem: " << tmp.range(18, 16) << "\n";
            tmp.range(7, 0) = y;
            o_oeste->write(tmp);
        } else {
